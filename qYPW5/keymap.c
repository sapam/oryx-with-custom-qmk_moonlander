...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_EQUAL,       TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    KC_MAC_PASTE,                                   DM_PLY1,        TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    KC_BSLS,        
    ...
    KC_LEFT_CTRL,   LT(1,KC_GRAVE), KC_LEFT_ALT,    KC_LEFT,        KC_RIGHT,       MO(2),                                                                                                          KC_ESCAPE,      KC_UP,          KC_DOWN,        KC_LBRC,        KC_RBRC,        TD(DANCE_10),   
  ...
  [4] = LAYOUT_moonlander(
    TO(0),          LALT(LCTL(KC_SCLN)),LALT(LCTL(KC_QUOTE)),KC_ENTER,       KC_NO,          LCTL(LSFT(KC_F8)),LCTL(LSFT(KC_SLASH)),                                LSFT(KC_BSLS),  LCTL(LSFT(KC_BSLS)),KC_NO,          KC_NO,          KC_NO,          KC_0,           LALT(KC_I),     
    LALT(LSFT(KC_SCLN)),KC_NO,          LSFT(KC_KP_8),  KC_NO,          KC_NO,          LALT(LSFT(KC_F8)),LALT(LSFT(KC_SLASH)),                                LCTL(KC_BSLS),  LALT(LSFT(KC_BSLS)),KC_7,           KC_8,           KC_9,           KC_NO,          LALT(LCTL(LSFT(KC_SCLN))),
    LALT(LSFT(KC_QUOTE)),LSFT(KC_KP_4),  LSFT(KC_KP_5),  LSFT(KC_KP_6),  KC_KP_PLUS,     LALT(LCTL(KC_F8)),LALT(LCTL(KC_SLASH)),                                                                LALT(KC_BSLS),  LALT(LCTL(KC_BSLS)),KC_4,           KC_5,           KC_6,           KC_NO,          LALT(LCTL(LSFT(KC_QUOTE))),
    LCTL(LSFT(KC_SCLN)),KC_NO,          LSFT(KC_KP_2),  KC_NO,          KC_KP_MINUS,    LALT(KC_F1),                                    ST_MACRO_2,     KC_1,           KC_2,           KC_3,           KC_NO,          KC_K,           
    LCTL(LSFT(KC_QUOTE)),KC_2,           KC_3,           LCTL(KC_PAGE_UP),LCTL(KC_INSERT),LSFT(KC_P),                                                                                                     LCTL(KC_E),     KC_QUOTE,       KC_SCLN,        KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_ALT,    
    KC_Q,           KC_T,           KC_Y,                           KC_W,           KC_E,           KC_R
  ),
  [5] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_F1,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_PC_PASTE,                                    DM_PLY1,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_RIGHT_ALT,                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [6] = LAYOUT_moonlander(
  ...
  [7] = LAYOUT_moonlander(
    KC_GRAVE,       TD(DANCE_11),   TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),   KC_F11,                                         KC_F12,         TD(DANCE_16),   TD(DANCE_17),   TD(DANCE_18),   TD(DANCE_19),   TD(DANCE_20),   KC_BSPC,        
